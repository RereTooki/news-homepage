    ...
    <>
      <div className="grid pr-[s40px] px-[15px] md:px-[55px] pt-[20px] overflow-hidden w-screen h-fit grid-cols-1 border-4 bg-off-whites">
        ...
        <div>
          ...
          <div className="md:w-auto pb-[25px] pt-[10px] px-[25px] h-auto divide-y divide-grayish-blues flex flex-col bg-very-dark-blues">
            <div>
        ...
        <div className="w-auto h-auto flex flex-row pt-[50px] pb-[20px]">
          <img className="w-[25%] h-[135px]" src={list1img} alt="A retro PC" />
        ...
        <div className="w-auto h-auto flex flex-row pb-[20px]">
          <img className="w-[25%] h-[135px]" src={list2img} alt="A retro PC" />
        ...
        <div className="w-auto h-auto flex flex-row">
          <img className="w-[25%] h-[135px]" src={list3img} alt="A retro PC" />
          <div className="flex flex-col pl-[15px]">
            <h1 className="text-grayish-blues text-[30px] font-bold pb-[25pxs]">
              03
            </h1>
